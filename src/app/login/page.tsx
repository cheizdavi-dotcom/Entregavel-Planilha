    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="mx-auto w-full max-w-sm glass-dark">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription>Entre na sua conta para ver seu painel.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            {!showEmailLogin ? (
                <div className="text-center">
                    <Button variant="link" onClick={() => setShowEmailLogin(true)} className="text-sm text-muted-foreground">
                        Ou entre com e-mail
                    </Button>
                </div>
            ) : (
              <form onSubmit={handleEmailLogin} className="space-y-4 pt-4 animate-in fade-in-0 zoom-in-95">
